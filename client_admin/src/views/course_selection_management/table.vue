<template>
	<el-main class="bg table_wrap">
			...
			<el-row>
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_wrap_1">
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/course_selection_management/table','add') || $check_action('/course_selection_management/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
            <el-button v-if="user_group == '管理员' || $check_action('/course_selection_management/table','del') || $check_action('/course_selection_management/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
					</el-form-item>
				</el-col>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/course_selection_management/table','set') || $check_action('/course_selection_management/view','set') || $check_action('/course_selection_management/view','get') || $check_action('/发布成绩/table','add') || $check_action('/发布成绩/view','add')" >


				<template slot-scope="scope">
					<router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
					v-if="user_group == '管理员' || $check_action('/course_selection_management/table','set') || $check_action('/course_selection_management/view','set') || $check_action('/course_selection_management/view','get')"
						:to="'./view?' + field + '=' + scope.row[field]"
						 size="small">
						<span>详情</span>
					</router-link>
					<!--跨表按钮-->
					<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/achievement_management/view')" v-if="user_group == '管理员' || $check_action('/achievement_management/table','add') || $check_action('/achievement_management/view','add')">
						<span>发布成绩</span>
					</el-button>
				</template>
			</el-table-column>
	...
	export default {
		...
		data() {
			return {
				...
				showModal: false,
				// 获取数据地址
				url_get_list: "~/api/course_selection_management/get_list?like=0",
				url_del: "~/api/course_selection_management/del?",
