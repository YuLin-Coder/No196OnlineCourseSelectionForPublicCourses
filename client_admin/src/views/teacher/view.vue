<template>
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','employee_number') || $check_field('add','employee_number') || $check_field('set','employee_number')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="职工号" prop="employee_number">
					<el-input id="employee_number" v-model="form_sub['employee_number']" placeholder="请输入职工号"
							  v-if="user_group === '管理员' || (form_sub['teacher_id'] && $check_field('set','employee_number')) || (!form_sub['teacher_id'] && $check_field('add','employee_number'))"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','college') || $check_field('add','college') || $check_field('set','college')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="学院" prop="college">
					<el-select id="college" v-model="form_sub['college']"
						v-if="user_group === '管理员' || (form_sub['teacher_id'] && $check_field('set','college')) || (!form_sub['teacher_id'] && $check_field('add','college'))">
