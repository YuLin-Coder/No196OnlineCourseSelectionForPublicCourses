<template>
	<div class="diy_details_box diy_div_course_selection_management">
		<div class="warp">
			<div class="container">
		...
		methods: {
			...
			change_praise(obj) {
				...
				var query = {
					...
					source_field: "course_selection_management_id",
					source_id: this.obj["course_selection_management_id"],
					user_id
				};
				...
				if (this.state_praise) {
					...
					this.$get('~/api/praise/del?', query, (res) => {
						if(res.result){
							...
							this.$post('~/api/course_selection_management/set?course_selection_management_id=' + _this.obj["course_selection_management_id"], {
								praise_len
							}, (res) => {
								if(res.result){
